...
class AppColors {
  // Light mode colors
  static const Color lightBackground = Color(0xFFFAF7F2); // Creme quente
  static const Color lightSurface = Color(0xFFFFFFFF); // Branco
  static const Color lightSurfaceVariant = Color(0xFFF5F0E8); // Cards
  ...
  static const Color darkPrimaryLight = Color(0xFFE8C99A); // Dourado suave (mesmo)
  ...
  static const Color darkTextHint = Color(0xFF6B5344); // Marrom médio escuro
